...
export function PersonalInfo () {
    const { selectedStep, personalInfo, setPersonalInfo, validEmail, validName, validPhone
    } = useFormContext();
        ...
        <>
            <div className={`bg-white absolute -top-[7rem] md:-top-[6rem] left-1/2 -translate-x-1/2 shadow w-[90%] max-w-[500px] md:max-w-[580px] mx-auto px-8 py-6 ${selectedStep !== 1 && "hidden"} lg:relative lg:top-0 lg:m-0 lg:p-0 lg:w-full lg:max-w-[100%] lg:shadow-none`}>
                    ...
                    <div className="lg:mb-8">
                        <h1 className="text-4xl text-marineBlue font-bold">Personal info</h1>
                    ...
                    <div className="lg:relative lg:mb-2">
                        ...
                        {!personalInfo.name && <p className="text-strawberryRed font-semibold text-[0.9rem] lg:absolute lg:top-0 lg:right-1">This field is required</p>}
                    </div>
                    ...
                    <div className="lg:relative lg:mb-2">
                        ...
                        {!personalInfo.email && <p className="text-strawberryRed font-semibold text-[0.9rem] lg:absolute lg:top-0 lg:right-1">This field is required</p>}
                    </div>
                    ...
                    <div className="lg:relative">
                        ...
                        {!personalInfo.phone && <p className="text-strawberryRed font-semibold text-[0.9rem] lg:absolute lg:top-0 lg:right-1">This field is required</p>}
                    </div>
            </div>
        </>
    );
